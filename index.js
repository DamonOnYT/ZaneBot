...
const ZaneQuoteList = [
    ...
    'wtf just seen in my memories that 2 years ago i was in egypt',
    'CHILDHOOD RUINED JAMIE',
    'i have 2 many snaps to respond to stop',
    'jamie not saying love u back hurts :/',
    'ok remind me to never say love u to jamie from this day on',
    'u kiss a girl so ur not gay',
    '@❖ Elliott stop killing my wife\n i have to keep doing cpr',
    'yo elliott why u putting photos of me on ur panel',
    'not me vibing to my music with my music blasting through my tv rn at 5:38 am',
    'keyfmlawyer@gmail.com - now hiring\n\nhttps://cdn.discordapp.com/attachments/704843393255211087/804517085731880990/unknown.png',
    'think u should be owner instead',
    'BYE WHO LET DAVE ON AIR',
    'disabling ur encoder after this slot dave \n enjoy it while it lasts',
    '@❖ David if u dont act normal on air i will boot u off air',
    'did dave just call me a whore on air',
    'thanks just got earraped by nowhits on air',
    'you can ask to be kidnapped by someone then you’ll be :sparkles: taken :sparkles:',
    'https://cdn.discordapp.com/attachments/704843393255211087/803422807106387988/wBsf4C1OF5JNwAAAABJRU5ErkJggg.png',
    'thought u were gonna say the olly one instead',
    'yOU TEASING ME YOU NAUGHTY NAUGHTY',
    'liam and aiden are shagging confirmed',
    'i want to buy @❖ Becs becs.systems',
    'YOU CANNOT SAY THAT UNLESS U WANT TO BE CANCELLED',
    'just got an image from daniel, he’s crying a river and ur data centre will now flood',
    'guys liam is offline for once\n we should celebrate\n he’s actually asleep',
    'can someone pls kill me thanks',
    'my brain just died',
    'shes an eggsexutive',
    'didnt u get a operation bc ur tranny',
    'wtf why does everyone want pics of me',
    'moderators he’s bullying me',
    'this isn’t keyfm.xxx live',
    'don’t talk to me bye blocking u',
    'oh that reminds me @LiamSYstems i am waiting for ur snap',
    'that is hamster abuse',
    'becs is the most useless executive i have at this site',
    'i fed u last night r u always hungry',
    '@LiamSystems don’t worry the bed is urs',
    'growls im not rich, im simply privileged',
    'we\'re all boobs',
